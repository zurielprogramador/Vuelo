 ...
 * Generated at: 2022-11-02 01:37:23 UTC
...
private String closeDiv(View view) {
  ...
  static {
    ...
    _jspx_dependants.put("/xava/referenceFrameHeaderExt.jsp", Long.valueOf(1667345014625L));
    _jspx_dependants.put("/xava/propertyActionsExt.jsp", Long.valueOf(1667345014622L));
    _jspx_dependants.put("/xava/collectionFrameHeaderExt.jsp", Long.valueOf(1667345014617L));
  }
...
if (!onlySections) {	// IF Not Only Sections
 ...
 if (!ref.isAggregate()) { 
      ...
      try {
        ...
        // /xava/detail.jsp(247,14) name = name type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
      ...
      try {
        ...
        // /xava/detail.jsp(270,13) name = name type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
...
if (view.hasSections()) { // IF Has Sections
      ...
      try {
        ...
        // /xava/detail.jsp(339,9) name = name type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
